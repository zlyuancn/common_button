...
const (
	...
	TaskPeriodType_TASK_PERIOD_TYPE_DAY_UTC8    TaskPeriodType = 1 // 自然日
	TaskPeriodType_TASK_PERIOD_TYPE_WEEK_0_UTC8 TaskPeriodType = 2 // 自然周(第一天是周日)
	TaskPeriodType_TASK_PERIOD_TYPE_WEEK_1_UTC8 TaskPeriodType = 3 // 自然周(第一天是周一)
	TaskPeriodType_TASK_PERIOD_TYPE_MONTH_UTC8  TaskPeriodType = 4 // 自然月
)
...
var (
	TaskPeriodType_name = map[int32]string{
		...
		1: "TASK_PERIOD_TYPE_DAY_UTC8",
		2: "TASK_PERIOD_TYPE_WEEK_0_UTC8",
		3: "TASK_PERIOD_TYPE_WEEK_1_UTC8",
		4: "TASK_PERIOD_TYPE_MONTH_UTC8",
	}
	TaskPeriodType_value = map[string]int32{
		"TASK_PERIOD_TYPE_NONE":        0,
		"TASK_PERIOD_TYPE_DAY_UTC8":    1,
		"TASK_PERIOD_TYPE_WEEK_0_UTC8": 2,
		"TASK_PERIOD_TYPE_WEEK_1_UTC8": 3,
		"TASK_PERIOD_TYPE_MONTH_UTC8":  4,
	}
)
...
const (
	...
	TaskType_TASK_TYPE_CHECKIN TaskType = 2 // 签到(直接完成)
)
...
const (
	...
	TaskFinishStatus_TASK_FINISH_STATUS_Hide       TaskFinishStatus = 3 // 已隐藏
)
...
type GetButtonListReq struct {
	...
	SceneId  []string       `protobuf:"bytes,2,rep,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`                                       // 区分场景id, 空列表表示拉取全部场景
}
...
func (x *GetButtonListReq) GetSceneId() []string {
	if x != nil {
		return x.SceneId
	}
	return nil
...
type OneClickFinishReq struct {
	...
	ModuleId ButtonModuleID `protobuf:"varint,1,opt,name=module_id,json=moduleId,proto3,enum=common_button.ButtonModuleID" json:"module_id,omitempty"` // 区分业务id
	SceneId  string         `protobuf:"bytes,2,opt,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`                                       // 区分场景id, 空列表表示拉取全部场景
}
...
func (x *OneClickFinishReq) GetSceneId() string {
	if x != nil {
		return x.SceneId
	}
	return ""
...
type Button struct {
	...
	SceneId      string         `protobuf:"bytes,2,opt,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`                                       // 场景id
...
func (x *Button) GetSceneId() string {
	if x != nil {
		return x.SceneId
	}
	return ""
...
type Prize struct {
	...
	PrizeData string `protobuf:"bytes,2,opt,name=prize_data,json=prizeData,proto3" json:"prize_data,omitempty"` // 奖品数据
}
...
func (x *Prize) GetPrizeData() string {
	if x != nil {
		return x.PrizeData
	}
	return ""
...
var file_button_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x69, 0x0a, 0x10, 0x47,
	0x65, 0x74, 0x42, 0x75, 0x74, 0x74, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12,
	...
	,
	...
	0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x22, 0x51, 0x0a, 0x11, 0x4f, 0x6e, 0x65, 0x43, 0x6c, 0x69,
	0x63, 0x6b, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x52, 0x73, 0x70, 0x12, 0x3c, 0x0a, 0x0a, 0x74,
	...
	0x74, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0xe6, 0x03, 0x0a, 0x06, 0x42, 0x75,
	0x74, 0x74, 0x6f, 0x6e, 0x12, 0x3a, 0x0a, 0x09, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x5f, 0x62, 0x75, 0x74, 0x74, 0x6f, 0x6e, 0x2e, 0x42, 0x75, 0x74, 0x74, 0x6f, 0x6e, 0x4d, 0x6f,
	...
	,
	...
	,
...
var file_button_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_button_proto_goTypes = []interface{}{
	...
	(TaskPeriodType)(0),       // 1: common_button.TaskPeriodType
	(TaskHideRule)(0),         // 2: common_button.TaskHideRule
	(TaskType)(0),             // 3: common_button.TaskType
	(TaskFinishStatus)(0),     // 4: common_button.TaskFinishStatus
	(*GetButtonListReq)(nil),  // 5: common_button.GetButtonListReq
	(*GetButtonListRsp)(nil),  // 6: common_button.GetButtonListRsp
	(*ClickButtonReq)(nil),    // 7: common_button.ClickButtonReq
	(*ClickButtonRsp)(nil),    // 8: common_button.ClickButtonRsp
	(*OneClickFinishReq)(nil), // 9: common_button.OneClickFinishReq
	(*OneClickFinishRsp)(nil), // 10: common_button.OneClickFinishRsp
	(*Button)(nil),            // 11: common_button.Button
	(*Task)(nil),              // 12: common_button.Task
	(*TaskState)(nil),         // 13: common_button.TaskState
	(*ClickTaskState)(nil),    // 14: common_button.ClickTaskState
	(*Prize)(nil),             // 15: common_button.Prize
}
var file_button_proto_depIdxs = []int32{
	0,  // 0: common_button.GetButtonListReq.module_id:type_name -> common_button.ButtonModuleID
	11, // 1: common_button.GetButtonListRsp.buttons:type_name -> common_button.Button
	14, // 2: common_button.ClickButtonRsp.task_state:type_name -> common_button.ClickTaskState
	0,  // 3: common_button.OneClickFinishReq.module_id:type_name -> common_button.ButtonModuleID
	14, // 4: common_button.OneClickFinishRsp.task_state:type_name -> common_button.ClickTaskState
	0,  // 5: common_button.Button.module_id:type_name -> common_button.ButtonModuleID
	12, // 6: common_button.Button.task:type_name -> common_button.Task
	13, // 7: common_button.Button.task_state:type_name -> common_button.TaskState
	15, // 8: common_button.Task.prizes:type_name -> common_button.Prize
	2,  // 9: common_button.Task.task_hide_rule:type_name -> common_button.TaskHideRule
	1,  // 10: common_button.Task.task_period_type:type_name -> common_button.TaskPeriodType
	3,  // 11: common_button.Task.task_type:type_name -> common_button.TaskType
	4,  // 12: common_button.TaskState.finish_status:type_name -> common_button.TaskFinishStatus
	4,  // 13: common_button.ClickTaskState.finish_status:type_name -> common_button.TaskFinishStatus
	15, // 14: common_button.ClickTaskState.prizes:type_name -> common_button.Prize
	5,  // 15: common_button.CommonButtonService.GetButtonList:input_type -> common_button.GetButtonListReq
	7,  // 16: common_button.CommonButtonService.ClickButton:input_type -> common_button.ClickButtonReq
	9,  // 17: common_button.CommonButtonService.OneClickFinish:input_type -> common_button.OneClickFinishReq
	6,  // 18: common_button.CommonButtonService.GetButtonList:output_type -> common_button.GetButtonListRsp
	8,  // 19: common_button.CommonButtonService.ClickButton:output_type -> common_button.ClickButtonRsp
	10, // 20: common_button.CommonButtonService.OneClickFinish:output_type -> common_button.OneClickFinishRsp
